package com.rbservice.yaga.custom.view
...
import com.rbservice.yaga.custom.view.ScreenUtils.getScreenHeight
import com.rbservice.yaga.custom.view.ScreenUtils.getScreenWidth
import com.rbservice.yaga.custom.view.ScreenUtils.getStatusHeight
import com.rbservice.yaga.custom.view.ScreenUtils.getVirtualBarHeigh
...
class MoveImageView : AppCompatImageView {
    ...
    private fun init() {
        ...
        screenHeight = getScreenHeight(context) //获得屏幕高度
        statusHeight = getStatusHeight(context) //获得状态栏的高度
        navigationHeight = getVirtualBarHeigh(context) //获取虚拟功能键高度
    }
